# Graph Report - qacwards  (2026-07-24)

## Corpus Check
- 162 files · ~3,226,474 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 776 nodes · 1105 edges · 64 communities (47 shown, 17 thin omitted)
...
- `/portal Is the Role Dispatcher` --references--> `PortalIndex()`  [INFERRED]
  plans/03-auth-role-gate.md → src/app/portal/page.tsx
...
Cohesion: 0.18
Nodes (10): CampusFolderPage(), CollegeFolderPage(), CollegePage(), CAMPUSES, COLLEGES, DOCUMENT_FOLDERS, SAMPLE_FILES, DocumentBrowser() (+2 more)
...
Cohesion: 0.21
Nodes (14): Commit Message Rules, Never Run Git, Do Not Infer Absent Content From a Gap, Image Cache Holds Only the Latest Message, Ink Overflow Needs scrollWidth, Not getBoundingClientRect, JSX Silently Eats Spaces Around </strong>, Lazy Images Are Blank in a fullPage Screenshot, Prototype-Matching Notes (+6 more)

### Community 4 - "Login and Auth Component Kit"
Cohesion: 0.08
Nodes (19): Dev-Only Role Switcher, normalize(), resolveDemoRole(), ROLE_BY_KEYWORD, LoginForm(), HEADING, ROLES, AuthButton() (+11 more)
...
Cohesion: 0.07
Nodes (30): Content Padding Differs Per Screen Family, The Sidebar Must Receive the User, NewAssignmentPage(), AssignmentPage(), DashboardPage(), DocumentsPage(), ENTRIES, TABS (+22 more)
...
Cohesion: 0.40
Nodes (6): portal-scale Zoom Utility, The *0.9 Damping Is Deliberate, zoom Does Not Rescale Viewport Units, An Empty Sidebar Is by Design, Say So, The Identity Seam, PortalLayout()
...
Cohesion: 0.05
Nodes (40): Fake Data Typed Into the Files, data.ts Is the Single Backend Swap Point, COLUMNS, SubmissionPage(), VIEWS, ASSIGNMENT_STEPS, ASSIGNMENTS, DASHBOARD_STATS (+32 more)

### Community 52 - "MiniCalendar.tsx"
Cohesion: 0.33
Nodes (5): DOT, DOT_LABEL, MeetingKind, MiniCalendarProps, WEEKDAYS

### Community 53 - "QAC Wards Accreditation System"
Cohesion: 0.13
Nodes (5): FileCard(), FolderEntry, RowList(), Step, VARIANTS
...
### Community 56 - "Accreditation Lifecycle"
Cohesion: 0.22
Nodes (8): Cap-Height Font-Size Recovery, Cap-Top to CSS Margin Formula, Next Dev Indicator Corrupts Pixel Scans, nextConfig, Figma Frames Are 1440x810 at 2x, Exports Are 2x of 1440x810 - Halve Everything, The 2.8% Antialiasing Pixel-Diff Floor, Playwright Verify Setup

### Community 58 - "InternalAccreditorEvaluation.tsx"
Cohesion: 0.40
Nodes (3): Accreditations Page Match Facts, ACCREDITATION_LEVELS, metadata

### Community 59 - "Role Claim Belongs in app_metadata"
Cohesion: 0.20
...
### Community 60 - "Can One Person Hold Two Roles?"
Cohesion: 0.40
Nodes (3): Gov. Recognitions Page Match Facts, metadata, RECOGNITIONS

### Community 63 - "CopcChart.tsx"
Cohesion: 0.50
...
### Community 69 - "The Figma Export Is the Only Blocker Left in 3a"
Cohesion: 0.67
...
## Knowledge Gaps
- **282 isolated node(s):** `live-handoff.sh script`, `post-edit-hook.sh script`, `pre-compact-handoff.sh script`, `pre-compact.sh script`, `session-start.sh script` (+277 more)
...
- **Why does `Phase 3a UI Build Runbook` connect `Prototype-Matching Method and Traps` to `Portal Routing and Auth Architecture`, `Design Tokens and Site Shell`, `The Figma Export Is the Only Blocker Left in 3a`, `Public Marketing Pages`, `Portal Shell and Identity Seam`, `events/page.tsx`, `kit/index.ts`, `Accreditation Lifecycle`, `Component Kit Rule`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `Phase 3a - Portal UI (static, no backend)` connect `Portal Routing and Auth Architecture` to `Design Tokens and Site Shell`, `Prototype-Matching Method and Traps`, `Login and Auth Component Kit`, `The Figma Export Is the Only Blocker Left in 3a`, `events/page.tsx`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `Kit Discipline` connect `Component Kit Rule` to `Prototype-Matching Method and Traps`, `QAC Wards Accreditation System`?**
