...
## Corpus Check
- 162 files · ~3,226,539 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 776 nodes · 1106 edges · 59 communities (41 shown, 18 thin omitted)
...
Cohesion: 0.12
Nodes (12): CampusFolderPage(), CollegeFolderPage(), CollegePage(), CAMPUSES, COLLEGES, DOCUMENT_FOLDERS, SAMPLE_FILES, DocumentBrowser() (+4 more)
...
Cohesion: 0.06
Nodes (41): Design System Rule - tokens only, The 31px Heading Snap, Gray #7B7979 (muted), Maroon #800000 (brand), Core Color Tokens, Yellow #EFBF04 (accent), Login Copyright Below the Token Floor, Derived Tokens - pending client sign-off (+33 more)

### Community 3 - "Prototype-Matching Method and Traps"
Cohesion: 0.07
Nodes (38): Commit Message Rules, Component Kit Rule, Kit Components Are Presentational, Never Run Git, Do Not Infer Absent Content From a Gap, Cap-Height Font-Size Recovery, Cap-Top to CSS Margin Formula, Next Dev Indicator Corrupts Pixel Scans (+30 more)
...
Cohesion: 0.10
Nodes (21): Content Padding Differs Per Screen Family, An Empty Sidebar Is by Design, Say So, The Identity Seam, /portal/performance and /portal/feedback 404, The Sidebar Must Receive the User, NewAssignmentPage(), AssignmentPage(), DashboardPage() (+13 more)
...
Cohesion: 0.25
Nodes (8): ProfilePage(), PROFILES, PasswordInput(), SelectInput(), SelectMenu(), shell(), TextInput(), SectionHeading()
...
Cohesion: 0.25
Nodes (5): ELIGIBLE_ACCREDITORS, NEW_ASSIGNMENT_FIELDS, FieldLabel(), PanelHeader(), COLUMNS
...
Cohesion: 0.15
Nodes (10): RowList(), FILL, LABEL, StatusBar, DocStatus, FILL, LABEL, StatusPill() (+2 more)
...
Cohesion: 0.06
Nodes (39): Fake Data Typed Into the Files, data.ts Is the Single Backend Swap Point, COLUMNS, SubmissionPage(), VIEWS, ASSIGNMENT_STEPS, ASSIGNMENTS, DASHBOARD_STATS (+31 more)
...
Cohesion: 0.15
Nodes (8): Crumb, VARIANTS, Size, SIZES, Variant, VARIANTS, SearchField(), BrowserView
...
- **Why does `Phase 3a UI Build Runbook` connect `Prototype-Matching Method and Traps` to `Portal Routing and Auth Architecture`, `Design Tokens and Site Shell`, `Public Marketing Pages`, `Portal Shell and Identity Seam`, `events/page.tsx`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `Phase 3a - Portal UI (static, no backend)` connect `Portal Routing and Auth Architecture` to `events/page.tsx`, `Design Tokens and Site Shell`, `Prototype-Matching Method and Traps`, `Login and Auth Component Kit`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `Kit Discipline` connect `Prototype-Matching Method and Traps` to `Decision: a Literal /portal Segment`?**
