# Graph Report - qacwards  (2026-07-26)

## Corpus Check
- 173 files · ~3,941,477 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 806 nodes · 1166 edges · 74 communities (56 shown, 18 thin omitted)
...
Cohesion: 0.17
Nodes (5): CAMPUSES, COLLEGES, DocumentBrowser(), FolderEntry, FolderGrid()
...
Cohesion: 0.17
Nodes (8): Phases 1-2 Are Done But Not Frozen, Per-Page Build Loop Protocol, Phase 2 - Public View, Phase 2 Done But Not Frozen, Per-Screen Build Loop, metadata, ICON_LINKS, PERSONNEL_LINK
...
Cohesion: 0.07
Nodes (27): Content Padding Differs Per Screen Family, /portal/performance and /portal/feedback 404, NewAssignmentPage(), AssignmentPage(), DocumentsPage(), ENTRIES, TABS, ProfilePage() (+19 more)
...
Cohesion: 0.12
Nodes (11): COLUMNS, AuthButton(), Size, Tone, ELIGIBLE_ACCREDITORS, NEW_ASSIGNMENT_FIELDS, REPORT_STATS, REPORTS (+3 more)
...
Cohesion: 0.14
Nodes (14): DashboardPage(), IA_DASHBOARD_STATS, IA_ONGOING_ACCREDITATION, PR_CALENDAR_MARKS, PR_CALENDAR_MONTH, PR_DASHBOARD_STATS, PR_DOC_STATUS, PR_ONGOING_ACCREDITATION (+6 more)
...
Cohesion: 0.15
Nodes (11): Fake Data Typed Into the Files, data.ts Is the Single Backend Swap Point, ASSIGNMENT_STEPS, ASSIGNMENTS, EVENT_MARKS, EVENT_MONTH, EVENT_TITLES, PortalNotification (+3 more)

### Community 52 - "MiniCalendar.tsx"
Cohesion: 0.27
Nodes (6): CampusFolderPage(), CollegeFolderPage(), DOCUMENT_FOLDERS, SAMPLE_FILES, EmptyState(), FileCard()

### Community 53 - "QAC Wards Accreditation System"
Cohesion: 0.14
Nodes (8): Component Kit Rule, Kit Components Are Presentational, Kit Discipline, Column, Row, RowList(), Step, VARIANTS

### Community 54 - "Phase Roadmap"
Cohesion: 0.25
Nodes (7): Keep Formatting in Components, Not Fake Data, Portal Bold Is font-semibold, DASHBOARD_STATS, Stat, StatCard(), StatRow(), QacPersonnelDashboard()
...
## Knowledge Gaps
- **283 isolated node(s):** `live-handoff.sh script`, `post-edit-hook.sh script`, `pre-compact-handoff.sh script`, `pre-compact.sh script`, `session-start.sh script` (+278 more)
...
- **Why does `Phase 3a UI Build Runbook` connect `Prototype-Matching Method and Traps` to `Design Tokens and Site Shell`, `Exports Are 2x of 1440x810 - Halve Everything`, `Public Marketing Pages`, `The Figma Export Is the Only Blocker Left in 3a`, `Portal Shell and Identity Seam`, `events/page.tsx`, `Can One Person Hold Two Roles?`, `QAC Wards Accreditation System`, `Phase Roadmap`, `The Identity Seam`, `dashboard/page.tsx`, `ProgressRow.tsx`?**
  _High betweenness centrality (0.110) - this node is a cross-community bridge._
- **Why does `Phase 3a - Portal UI (static, no backend)` connect `ProgressRow.tsx` to `Design Tokens and Site Shell`, `Prototype-Matching Method and Traps`, `The Figma Export Is the Only Blocker Left in 3a`, `events/page.tsx`, `The Identity Seam`, `StatRow`?**
...
- **Should `Package Manifest and Dependencies` be split into smaller, more focused modules?**
