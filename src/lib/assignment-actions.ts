 ...
 *
 * The two state machines are plain transition tables plus a Postgres enum rather
 * than XState (§0.2): two machines with at most six states each, where a library
 * would add a dependency and a second place for the truth to live. The tables
 * below are the whole of the logic.
 */
